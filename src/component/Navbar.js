  ...
  return (
    <div className="z-30 flex justify-between items-center px-6 bg-white shadow-md absolute top-0 left-0 right-0 h-14">
      ...
      <div className="hidden md:flex justify-between items-center w-full max-w-3xl text-gray-900 font-bold">
        <Link
          to={ "/about" }
          className={ `flex items-center px-5 py-1 bg-slate-50 rounded-full border-2 ${ path === "/about" ? "border-blue-500" : "border-transparent shadow"
            }` }
        >
          About
        </Link>
        <Link
          to="/research"
          className={ `flex items-center px-5 py-1 bg-slate-50 rounded-full border-2 ${ path === "/research"
              ? "border-blue-500"
        ...
        <Link
          to="/teaching"
          className={ `flex items-center px-5 py-1 bg-slate-50 rounded-full border-2 ${ path === "/teaching"
              ? "border-blue-500"
              : "border-transparent shadow"
            }` }
        >
